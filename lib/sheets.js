...
async function saveOrder({ uniqueCode, buyerEmail, accountEmail, accountPassword, orderId, productType, productName }) {
  ...
  await sheets.spreadsheets.values.append({
    ...
    requestBody: { values: [[ uniqueCode, buyerEmail, `${accountEmail}:${accountPassword}`, new Date().toISOString(), orderId, productType, productName ]] },
  });
}
...
module.exports = { getNextAvailableAccount, deleteAccountRow, saveOrder, findOrderByCode, getAllStock, SHEET_NAME, ORDERS_SHEET };
